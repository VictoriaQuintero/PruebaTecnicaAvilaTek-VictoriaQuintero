...
export default function Hero() {
    return (
        <div className="pb-16 lg:pt-8 lg:px-8 lg:flex lg:flex-col lg:items-center">
            <div className="bg-[#53389E] px-4 lg:w-[90%] lg:rounded-3xl lg:px-8 lg:pt-24 lg:pb-48 lg:flex lg:flex-col lg:items-center">
                <div className="pt-16 pb-24 flex flex-col gap-10 lg:gap-12 lg:w-3/4 lg:p-0">
                    <div className="flex flex-col gap-4 lg:gap-6">
                        <h1 className="text-white text-4xl font-semibold text-center lg:text-7xl">Grow your users. <span className="text-[#E9D7FE]">Smarter.</span></h1>
                        <p className="text-[#E9D7FE] text-lg text-center lg:text-xl">Powerful, self-serve product and growth analytics to help you convert, engage, and retain more users. Trusted by over 4,000 startups.</p>
                    </div>
